...
@section('title') Edit Lab Result Orders @endsection
      ...
      <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <strong>Edit Lab Result Orders</strong>
            </div>
            <div class="card-body card-block">
              <form method="post" action="{{route('lab_result_orders.update',$lab->id)}}" enctype="multipart/form-data">
                @csrf 
                @method('PATCH')
